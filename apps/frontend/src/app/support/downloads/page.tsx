export const metadata = { title: "Download Center | Support" };

export default function Page() {
  return (
    <main className="bg-muted py-20">
      <div className="container">
        <h1 className="text-5xl font-bold text-dark">Download Center</h1>
        <p className="mt-5 max-w-3xl text-lg text-slate-600">Product manuals, datasheets, installation guides and catalog files.</p>
