export const metadata = { title: "Certificates | Support" };

export default function Page() {
  return (
    <main className="bg-muted py-20">
      <div className="container">
        <h1 className="text-5xl font-bold text-dark">Certificates</h1>
        <p className="mt-5 max-w-3xl text-lg text-slate-600">Product compliance and quality management documents.</p>
